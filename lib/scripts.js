...
// as opposed to the one you wanted to delete.
//   ideaTank.forEach(function (element) {
...
function findIdeaQuality(e) {
  return $(e).closest('.new-ideas').find('.quality').text();
}

$('.ideas').on('click', '.up', function(){
  console.log(findIdeaQuality(this))
