...
$('.ideas').on('click', '.complete', function(){
  let thisDiv = $(this).closest('.new-ideas')
  thisDiv.toggleClass("completed")
});
...
// arrange by quality
const qualityLow = $('.low');
qualityLow.on('click', function() {
  let qualityBtn = $(this).text();
  // console.log(qualityBtn)
  $('.new-ideas').each(function (index, element) {
    let btn = $(element).text();
    let match = !!btn.match(qualityBtn);
    $(element).toggle(match);
  });
});

const qualityNone = $('.none');
qualityNone.on('click', function() {
  let qualityBtn = $(this).text();
  // console.log(qualityBtn)
  $('.new-ideas').each(function (index, element) {
    let btn = $(element).text();
...
qualityNormal.on('click', function() {
  let qualityBtn = $(this).text();
  // console.log(qualityBtn)
  $('.new-ideas').each(function (index, element) {
    let btn = $(element).text();
...
const qualityCritical = $('.critical');
qualityCritical.on('click', function() {
  let qualityBtn = $(this).text();
  // console.log(qualityBtn)
  $('.new-ideas').each(function (index, element) {
    let btn = $(element).text();
